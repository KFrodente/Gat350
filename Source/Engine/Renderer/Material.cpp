...
namespace nc
{
	bool Material::Create(std::string filename, ...)
	{
		...
		std::string cubemapTextureName;
		if (READ_NAME_DATA(document, "cubemap", cubemapTextureName))
		{
			std::vector<std::string> cubemaps;
			READ_DATA(document, cubemaps);
			cubemapTexture = GET_RESOURCE(Cubemap, cubemapTextureName, cubemaps);
		}
	...
	void Material::ProcessGui()
	{
		...
		Gui::GetDialogueResource<Program>(m_program, "ShaderTextureDialogue", "Open Shader", "Shader file (*.prog){.prog},.*");
		...
		Gui::GetDialogueResource<Texture>(albedoTexture, "AlbedoTextureDialogue", "Open texture", "Image file (*.png;*.jpg;*.jpeg;*.bmp;*.tga){.png,.jpg,.jpeg,.bmp,.tga},.*");
		...
		Gui::GetDialogueResource<Texture>(specularTexture, "SpecularTextureDialogue", "Open texture", "Image file (*.png;*.jpg;*.jpeg;*.bmp;*.tga){.png,.jpg,.jpeg,.bmp,.tga},.*");
		...
		Gui::GetDialogueResource<Texture>(emissiveTexture, "EmissiveTextureDialogue", "Open texture", "Image file (*.png;*.jpg;*.jpeg;*.bmp;*.tga){.png,.jpg,.jpeg,.bmp,.tga},.*");
